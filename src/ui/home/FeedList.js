...
import {View, StyleSheet, FlatList, RefreshControl, Text, ScrollView, AppState, DeviceEventEmitter, Linking} from 'react-native';
      ...
      <View style={styles.locationContainer}>
        {!locationUpdated && (
          <>
            ...
            }} btnStyle={styles.enablePermission} btnText={'Enable location permission'} />
          </>
        )}
