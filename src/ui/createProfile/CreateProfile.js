...
const CreateProfile = _ => {
  ...
  const createProfile = async () => {
    try {
      const validateData = await registerSchema.validate({
        email: email,
        gender: genderType,
        firstName: name,
        lastName: lastName,
      ...
      dispatch(
        updateAuthUserData({...update, accessToken: userData?.accessToken}),
      );
        ...
        <View style={{flex: 1, padding: 15}}>
          ...
          <Pressable onPress={openDialog} style={styles.imageContainer}>
            <Image
              ...
              source={baseImage ? {uri: baseImage} : imagePath.user}
            />
          ...
          <FlexSBContainer
            ...
            <FlexSBContainer
              ...
              containerStyle={{
                ...
                marginEnd: 10,
                borderColor: genderType === 1 ? colors.themeColor : colors.grey,
              }}>
              <Image
                style={{
                  ...styles.genderIcon,
                  tintColor:
                    genderType === 1 ? colors.themeColor : colors.black,
                }}
              ...
              <Text
                style={{
                  ...
                  color: genderType === 1 ? colors.themeColor : colors.black,
            ...
            <FlexSBContainer
              ...
              containerStyle={{
                ...styles.genderContainer,
                borderColor: genderType === 2 ? colors.themeColor : colors.grey,
              }}>
              <Image
                style={{
                  ...styles.genderIcon,
                  tintColor:
                    genderType === 2 ? colors.themeColor : colors.black,
                }}
                source={imagePath.femenine}
              />
              <Text
                style={{
                  ...commonStyles.fontSize14,
                  color: genderType === 2 ? colors.themeColor : colors.black,
                  marginStart: rspW(2.6),
                }}>
                {'Female'}
              </Text>
